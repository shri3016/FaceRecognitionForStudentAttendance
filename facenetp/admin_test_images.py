...
test_images_student_folder = os.path.join(test_images_folder, person_name)
...
test_images_student_folder = os.path.join(test_images_folder, person_name)
test_images_cropped_person_folder = os.path.join(test_images_cropped_folder, person_name)
